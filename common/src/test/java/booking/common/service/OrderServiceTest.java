...
public class OrderServiceTest extends IntegrationTestBase {
    ...
    public void makeOrderTest() {
        ...
        Optional<UserInfoDto> hotelOwner = hotelService.getHotelOwner(roomOptional.get().getHotel().getId());
        ...
        hotelOwner = hotelService.getHotelOwner(roomOptional.get().getHotel().getId());
        assertTrue(hotelOwner.isPresent());
    ...
    public void cancelOrderTest() {
        ...
        var balanceUserBefore = walletService.getUserBalance(userId);
        Optional<UserInfoDto> hotelOwner = hotelService.getHotelOwner(room.get().getHotel().getId());
        assertTrue(hotelOwner.isPresent());
        var balanceOwnerBefore = walletService.getUserBalance(hotelOwner.get().getId());
