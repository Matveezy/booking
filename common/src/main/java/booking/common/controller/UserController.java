...
import booking.common.service.HotelService;
import booking.common.service.OrdersService;
import booking.common.service.RoomService;
...
public class UserController {
    ...
    @PreAuthorize("hasAuthority('USER')")
    public List<OrderInfoDto> showOrders(@PathVariable long userId) {
