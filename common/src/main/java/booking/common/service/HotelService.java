...
import booking.common.mapper.HotelReadMapper;
...
public class HotelService {
    ...
    public Optional<UserInfoDto> getHotelOwner(Long hotelId) {
    ...
    public Long saveHotel(HotelCreateDto hotelCreateDto) {
        ...
        Optional<UserInfoDto> userReadDtoOptional = userService.findByLogin(principal.getUsername());
